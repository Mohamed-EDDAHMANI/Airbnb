            ...
            <form class="space-y-6" method="POST" action="/singUp">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <label
                            class="flex items-center p-4 border rounded-lg cursor-pointer hover:border-blue-500 transition-colors">
                            <input type="radio" name="role" value="voyageur" class="mr-3">
                            <span>Voyageur</span>
                        </label>
                        <label
                            class="flex items-center p-4 border rounded-lg cursor-pointer hover:border-blue-500 transition-colors">
                            <input type="radio" name="role" value="proprietaire" class="mr-3">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Create a password</label>
